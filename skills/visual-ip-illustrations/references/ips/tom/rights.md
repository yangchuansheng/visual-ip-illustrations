...
- Release reviewers should verify the exact rights entity named in any project-specific authorization before changing route status or public sample policy.
...
- Owner: maintainer / release reviewer for the Tom route.
- Review purpose: decide whether Tom remains `gated-authorized`, moves to an approved active route, or stays withheld from public release materials.
- Required review fields: reviewer, review date, approval status, authorization scope, allowed use, restricted use, distribution channels, and public-sample decision.
