...
Visual IP Illustrations is the current release 1.4 public identity for this multi-IP article illustration skill. The rebrand scope covers public documentation, prompt examples, NOTICE wording, release checklist gates, canonical invocation `$visual-ip-illustrations`, and canonical checkout slug `visual-ip-illustrations`; the installable package directory remains `ian-xiaohei-illustrations/`, and the legacy `$ian-xiaohei-illustrations` alias remains a compatibility surface.
